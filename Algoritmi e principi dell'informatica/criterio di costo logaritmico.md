...
E spesso si rientra in questi casi, ma non sempre, per $2^{2^n}$, il suo costo a criterio di costo logaritmico è $2^n$, infatti la [[complessità]] temporale $>=$ [[complessità spaziale]] che è $\Theta(2^n)$.
