...
\tikz[animate = {1 : fill = {0s = "white", 2s = "gray", begin = 0s}}];

\node[draw,text=red!90,text opacity = 1,fill]  (0) at (0,0){1};
\node[below left of = 0,draw,text opacity = 0.75,fill = gray] (1) {2};
