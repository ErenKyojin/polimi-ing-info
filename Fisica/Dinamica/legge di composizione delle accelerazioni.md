...
$$
\vec{a}_{a} = \frac{d\vec{v}_{a}}{dt} = \frac{d(\vec{v}_{r} + \vec{v}_{t})}{dt} = \frac{d}{dt} \left[ \left( \frac{dx'}{dt}\hat{u}_{x'} + \frac{dy'}{dt}\hat{u}_{y'} + \frac{dz'}{dt}\hat{u}_{z'}    \right) + \left( x'\frac{d\hat{u}_{x'}}{dt}  \right) \right]   
$$