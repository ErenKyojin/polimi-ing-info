...
$$ \mathcal{L}_{A \to B,\gamma} \triangleq \sum_{i = 1}^n \mathcal{L}_{A_{i} \to B_{i},\gamma_{i}} = \sum_{i=1}^n \Delta E_{c,i}(A_{i},B_{i}) = \sum_{i = 1}^n E_{c,i}(B_{i}) - \sum_{i = 1}^n E_{c,i}(A_{i}) = E_{c}(B) - E_{c}(A)$$
