...
- **Proprietà transitiva**: Si dice che una relazione $R$ gode della proprietà transitiva (o semplicementre è transitiva) se per ogni $a_{1},a_{2},a_{3} \in A$, $(a_{1},a_{2}) \in R$ e $(a_{2},a_{3})\in R$ implicano $(a_{1},a_{3}) \in R$. Si può facilmente provare che una relazione è transitiva s
