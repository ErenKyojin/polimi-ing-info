...
>
>Date le clausole $C_{1},C_{2}$ ed $R$ si dice che $R$ è una risolvente di $C_{1}$ e $C_{2}$ se esiste un letterale $L \in C_{1}$ tale che $\sim L \in C_{2}$ e $R = (C_{1} \setminus \{ L \}) \cup (C_{2} s$