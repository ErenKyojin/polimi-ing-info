...
function init(component, options, instance10, create_fragment13, not_equal, props, append_styles2, dirty = [-1]) {
...
function computeOverlap(items) {
  return items.reduce((overlapLookup2, item) => {
    const overlapGroup = getItemsOverlappingItemAndEachOther(item, items);
    return computeOverlapForGroup(overlapGroup, overlapLookup2);
  }, /* @__PURE__ */ new Map());
}
...
function computeOverlapForGroup(overlapGroup, previousLookup) {
  ...
  const [itemsPlacedPreviously, itemsToBePlaced] = (0, import_fp.partition)(
    ({ id }) => newLookup.has(id),
    overlapGroup
  );
...
async function refreshPlanItemsInStore() {
...
async function createDailyNoteIfNeeded() {
  return getDailyNoteForToday() || (0, import_obsidian_daily_notes_interface2.createDailyNote)(window.moment());
}
function getDailyNoteForToday() {
  return (0, import_obsidian_daily_notes_interface2.getDailyNote)(window.moment(), (0, import_obsidian_daily_notes_interface2.getAllDailyNotes)());
}
...
function getMomentFromUid(uid) {
  const dailyNote = (0, import_obsidian_daily_notes_interface2.getAllDailyNotes)()[uid];
  if (!dailyNote) {
    throw new Error(`No daily note: ${uid}`);
  }
  return (0, import_obsidian_daily_notes_interface2.getDateFromFile)(dailyNote, "day");
}
...
var overlapLookup = derived(tasks, ($tasks) => computeOverlap($tasks));
var activeDay = writable((0, import_obsidian_daily_notes_interface3.getDateUID)(window.moment(), "day"));
var activeDayShown = derived(
  activeDay,
  ($activeDay) => (0, import_obsidian_daily_notes_interface3.getAllDailyNotes)()[$activeDay] === getDailyNoteForToday()
);
function getMomentOfActiveDay() {
  return getMomentFromUid(get_store_value(activeDay));
}
activeDay.subscribe(async () => {
  await refreshPlanItemsInStore();
});
function getTimelineFile() {
  return (0, import_obsidian_daily_notes_interface3.getAllDailyNotes)()[get_store_value(activeDay)];
}
...
function add_css(target) {
  append_styles(target, "svelte-98j5aj", ".hours-container.svelte-98j5aj.svelte-98j5aj{display:flex;flex:0 0 40px;flex-direction:column}.hour.svelte-98j5aj.svelte-98j5aj{display:flex;flex-grow:1;flex-shrink:0}.hour-guide.svelte-98j5aj.svelte-98j5aj{flex:0 0 10px}.hour.svelte-98j5aj:not(:first-child) .hour-guide.svelte-98j5aj{border-top:1px solid var(--background-modifier-border)}.hour-number-container.svelte-98j5aj.svelte-98j5aj{position:sticky;top:10px;transform:translateY(\n      calc(var(--font-ui-small) * var(--line-height-tight) / -2)\n    );display:flex;flex:0 0 30px;align-self:flex-start;justify-content:center;font-size:var(--nav-item-size);color:var(--text-muted)}");
}
...
function create_each_block(ctx) {
  ...
  return {
    c() {
      ...
      div1 = element("div");
      t2 = space();
      attr(div0, "class", "hour-number-container svelte-98j5aj");
      attr(div1, "class", "hour-guide svelte-98j5aj");
      attr(div2, "class", "hour svelte-98j5aj");
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "hours-container svelte-98j5aj");
    },
    m(target, anchor) {
...
// src/store/time.ts
var time2 = readable(window.moment(), (set) => {
...
function instance3($$self, $$props, $$invalidate) {
  ...
  let $settings;
  component_subscribe($$self, time2, ($$value) => $$invalidate(3, $time = $$value));
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*$timeToTimelineOffset, $time*/
    24) {
      $: {
        $$invalidate(1, coords = $timeToTimelineOffset(getMinutesSinceMidnight($time)));
        scrollIntoView();
      }
    }
  };
  return [el, coords, scrollBlockedByUser, $time, $timeToTimelineOffset, div_binding];
}
...
function instance4($$self, $$props, $$invalidate) {
  ...
  let markdownLifecycleManager = new import_obsidian4.Component();
  ...
  $$self.$$.update = () => {
    ...
    15) {
      $:
        if (renderedMarkdown) {
          markdownLifecycleManager.unload();
          $$invalidate(2, markdownLifecycleManager = new import_obsidian4.Component());
          renderedMarkdown.empty();
          import_obsidian4.MarkdownRenderer.render($appStore, text2, renderedMarkdown, "", markdownLifecycleManager);
...
function useDrag() {
  ...
  async function handleMoveConfirm(offset, id, durationMinutes) {
    dragging.set(false);
...
function useResize() {
  ...
  async function handleResizeConfirm(id, taskHeight, startMinutes) {
...
function add_css5(target) {
  append_styles(target, "svelte-17dtddx", ".gap-box.svelte-17dtddx{display:flex;padding-right:3px;padding-left:3px;transition:0.05s linear}.task.svelte-17dtddx{overflow:visible;display:flex;flex:1 0 0;align-items:flex-start;justify-content:flex-start;padding:5px;font-size:var(--font-ui-medium);color:var(--text-muted);text-align:left;overflow-wrap:anywhere;white-space:normal;background-color:var(--background-primary);border:1px solid var(--text-faint);border-radius:var(--radius-s)}.past.svelte-17dtddx{background-color:var(--background-secondary)}.present.svelte-17dtddx{border-color:var(--color-accent)}.is-ghost.svelte-17dtddx{opacity:0.6}.task.svelte-17dtddx:hover{cursor:grab}.resize-handle.svelte-17dtddx{cursor:s-resize;bottom:-15px;height:30px}");
}
function create_fragment5(ctx) {
  ...
  ctx[11]}px)`;
  let style_width = `${/*widthPercent*/
  ctx[8]}%`;
  let style_left = `${/*xOffsetPercent*/
  ctx[7]}%`;
  let current;
  let mounted;
  let dispose;
  ...
  return {
    c() {
      ...
      t1 = space();
      div0 = element("div");
      attr(div0, "class", "resize-handle absolute-stretch-x svelte-17dtddx");
      attr(div1, "class", div1_class_value = "task " + /*relationToNow*/
      ctx[6] + " svelte-17dtddx");
      toggle_class(
        div1,
        "is-ghost",
        /*isGhost*/
      ...
      attr(div2, "class", "gap-box absolute-stretch-x svelte-17dtddx");
      set_style(div2, "height", style_height);
      ...
      set_style(div2, "width", style_width);
    ...
    p(ctx2, dirty) {
      ...
      64 && div1_class_value !== (div1_class_value = "task " + /*relationToNow*/
      ctx2[6] + " svelte-17dtddx")) {
      ...
      if (dirty[0] & /*height*/
      1024 && style_height !== (style_height = `${/*height*/
      ctx2[10]}px`)) {
        set_style(div2, "height", style_height);
      }
      if (dirty[0] & /*offset*/
      2048 && style_transform !== (style_transform = `translateY(${/*offset*/
      ctx2[11]}px)`)) {
        set_style(div2, "transform", style_transform);
      }
      if (dirty[0] & /*cursor*/
      ...
      if (dirty[0] & /*widthPercent*/
      256 && style_width !== (style_width = `${/*widthPercent*/
      ctx2[8]}%`)) {
        set_style(div2, "width", style_width);
      }
      if (dirty[0] & /*xOffsetPercent*/
      128 && style_left !== (style_left = `${/*xOffsetPercent*/
      ctx2[7]}%`)) {
        set_style(div2, "left", style_left);
      }
    },
...
function instance5($$self, $$props, $$invalidate) {
  ...
  let $settings;
  let $resizing;
  let $pointerYOffset, $$unsubscribe_pointerYOffset = noop, $$subscribe_pointerYOffset = () => ($$unsubscribe_pointerYOffset(), $$unsubscribe_pointerYOffset = subscribe(pointerYOffset, ($$value) => $$invalidate(31, $pointerYOffset = $$value)), pointerYOffset);
  let $pointerYOffsetToTaskStart;
  let $timeToTimelineOffset;
  component_subscribe($$self, time2, ($$value) => $$invalidate(25, $time = $$value));
  component_subscribe($$self, overlapLookup, ($$value) => $$invalidate(26, $overlapLookup = $$value));
  component_subscribe($$self, durationToSize, ($$value) => $$invalidate(28, $durationToSize = $$value));
  component_subscribe($$self, settings, ($$value) => $$invalidate(29, $settings = $$value));
  component_subscribe($$self, timeToTimelineOffset, ($$value) => $$invalidate(33, $timeToTimelineOffset = $$value));
  ...
  component_subscribe($$self, dragging, (value) => $$invalidate(27, $dragging = value));
  component_subscribe($$self, pointerYOffsetToTaskStart, (value) => $$invalidate(32, $pointerYOffsetToTaskStart = value));
  const { resizing, handleResizeStart, handleResizeCancel, handleResizeConfirm } = useResize();
  component_subscribe($$self, resizing, (value) => $$invalidate(30, $resizing = value));
  function handleCancel() {
    handleMoveCancel();
    handleResizeCancel();
  }
  const mouseup_handler = () => handleResizeConfirm(id, height, startMinutes);
  const mouseup_handler_1 = () => handleMoveConfirm(Math.floor(offset), id, durationMinutes);
  $$self.$$set = ($$props2) => {
    if ("text" in $$props2)
    ...
    if ("startTime" in $$props2)
      $$invalidate(20, startTime = $$props2.startTime);
    if ("endTime" in $$props2)
      $$invalidate(21, endTime = $$props2.endTime);
    if ("startMinutes" in $$props2)
      $$invalidate(2, startMinutes = $$props2.startMinutes);
    if ("durationMinutes" in $$props2)
      $$invalidate(3, durationMinutes = $$props2.durationMinutes);
    if ("pointerYOffset" in $$props2)
      $$subscribe_pointerYOffset($$invalidate(4, pointerYOffset = $$props2.pointerYOffset));
    if ("isGhost" in $$props2)
      $$invalidate(5, isGhost = $$props2.isGhost);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty[0] & /*isGhost, startMinutes*/
    36 | $$self.$$.dirty[1] & /*$pointerYOffset, $timeToTimelineOffset*/
    5) {
      $:
        $$invalidate(24, initialOffset = isGhost ? roundToSnapStep($pointerYOffset) : $timeToTimelineOffset(startMinutes));
    }
    if ($$self.$$.dirty[0] & /*$dragging, initialOffset*/
    150994944 | $$self.$$.dirty[1] & /*$pointerYOffset, $pointerYOffsetToTaskStart*/
    3) {
      $:
        $$invalidate(11, offset = $dragging ? roundToSnapStep($pointerYOffset - $pointerYOffsetToTaskStart) : initialOffset);
    }
    if ($$self.$$.dirty[0] & /*initialOffset*/
    16777216 | $$self.$$.dirty[1] & /*$pointerYOffset*/
    1) {
      $:
        $$invalidate(23, offsetToPointer = $pointerYOffset - initialOffset);
    }
    if ($$self.$$.dirty[0] & /*$resizing, offsetToPointer, $settings, $durationToSize, durationMinutes*/
    1887436808) {
      $:
        $$invalidate(10, height = $resizing ? roundToSnapStep(offsetToPointer) + SNAP_STEP_MINUTES * $settings.zoomLevel : $durationToSize(durationMinutes));
    }
    if ($$self.$$.dirty[0] & /*$dragging*/
    134217728) {
      $:
        $$invalidate(9, cursor = $dragging ? "grabbing" : "grab");
    }
    if ($$self.$$.dirty[0] & /*$overlapLookup, id*/
    67108866) {
      $:
        $$invalidate(22, itemPlacing = $overlapLookup.get(id));
    }
    if ($$self.$$.dirty[0] & /*itemPlacing*/
    4194304) {
      $:
        $$invalidate(8, widthPercent = itemPlacing ? itemPlacing.span / itemPlacing.columns * 100 : 100);
    }
    if ($$self.$$.dirty[0] & /*itemPlacing*/
    4194304) {
      $:
        $$invalidate(7, xOffsetPercent = itemPlacing ? 100 / itemPlacing.columns * itemPlacing.start : 0);
    }
    if ($$self.$$.dirty[0] & /*isGhost, $time, startTime, endTime*/
    36700192) {
      $:
        $$invalidate(6, relationToNow = isGhost ? "future" : getRelationToNow($time, startTime, endTime));
    }
  };
  return [
    text2,
...
function add_css6(target) {
  append_styles(target, "svelte-nqnqha", ".task-container.svelte-nqnqha{top:0;bottom:0;display:flex;flex-direction:column;margin-right:10px;margin-left:20px}");
}
...
function create_fragment6(ctx) {
  ...
  const get_key = (ctx2) => `${/*taskProps*/
  ctx2[12].startTime} ${/*taskProps*/
  ctx2[12].text}`;
  for (let i = 0; i < each_value.length; i += 1) {
  ...
  return {
    c() {
      ...
      if (if_block)
        if_block.c();
      attr(div, "class", "task-container absolute-stretch-x svelte-nqnqha");
    },
    m(target, anchor) {
      insert(target, t0, anchor);
      insert(target, div, anchor);
...
function add_css7(target) {
  append_styles(target, "svelte-1lkmq7w", ".clickable-icon.svelte-1lkmq7w{flex-basis:var(--input-height);align-self:center;grid-column-start:var(--grid-column-start, auto);justify-self:var(--justify-self, auto);white-space:nowrap}");
}
function create_fragment7(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      4 && div_class_value !== (div_class_value = "clickable-icon " + /*classes*/
      ctx2[2] + " svelte-1lkmq7w")) {
...
function instance7($$self, $$props, $$invalidate) {
  ...
  return [label, isActive, classes, $$scope, slots, click_handler];
}
var Control_button = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance7, create_fragment7, safe_not_equal, { label: 0, isActive: 1, classes: 2 }, add_css7);
  }
};
...
function add_css8(target) {
  append_styles(target, "svelte-1mvnq6g", ".date.svelte-1mvnq6g{display:flex;align-items:center;justify-content:center;font-size:var(--font-ui-small);font-weight:var(--font-medium);color:var(--text-normal)}.settings.svelte-1mvnq6g{margin:var(--size-4-1) var(--size-4-4)}.setting-item.svelte-1mvnq6g{padding:var(--size-2-3) 0;border:none}.setting-item-name.svelte-1mvnq6g{font-size:var(--font-ui-small)}.controls.svelte-1mvnq6g{display:flex;flex-direction:column;border-bottom:1px solid var(--background-modifier-border)}.header.svelte-1mvnq6g{display:grid;gap:10px;grid-template-columns:repeat(5, 1fr);justify-content:center;margin:var(--size-4-2)}");
}
...
function create_default_slot_2(ctx) {
  let span;
  let t_value = (0, import_obsidian_daily_notes_interface4.getAllDailyNotes)()[
    /*$activeDay*/
    ctx[1]
  ].basename + "";
  let t;
  return {
    c() {
      span = element("span");
      t = text(t_value);
      attr(span, "class", "date svelte-1mvnq6g");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      if (dirty & /*$activeDay*/
      2 && t_value !== (t_value = (0, import_obsidian_daily_notes_interface4.getAllDailyNotes)()[
        /*$activeDay*/
        ctx2[1]
      ].basename + ""))
        set_data(t, t_value);
...
function create_if_block2(ctx) {
  ...
  return {
    c() {
      ...
      div3 = element("div");
      div1 = element("div");
      div1.innerHTML = `<div class="setting-item-name svelte-1mvnq6g">Zoom</div>`;
      t1 = space();
      div2 = element("div");
      ...
      div8 = element("div");
      div5 = element("div");
      div5.innerHTML = `<div class="setting-item-name svelte-1mvnq6g">Auto-scroll to now</div>`;
      t4 = space();
      div7 = element("div");
      div6 = element("div");
      ...
      attr(div3, "class", "setting-item svelte-1mvnq6g");
      ...
      attr(div8, "class", "setting-item mod-toggle svelte-1mvnq6g");
      attr(div9, "class", "settings svelte-1mvnq6g");
    },
    m(target, anchor) {
...
function create_fragment11(ctx) {
  ...
  return {
    c() {
      ...
      set_style(div, "--grid-column-start", "2");
      set_style(div_1, "display", "contents");
      set_style(div_1, "--justify-self", "flex-end");
      attr(div0, "class", "header svelte-1mvnq6g");
      attr(div1, "class", "controls svelte-1mvnq6g");
    },
    m(target, anchor) {
      insert(target, div1, anchor);
      append(div1, div0);
    ...
    p(ctx2, [dirty]) {
      ...
      1)
        controlbutton3_changes.isActive = /*settingsVisible*/
        ctx2[0];
      if (dirty & /*$$scope*/
      4096) {
...
function instance8($$self, $$props, $$invalidate) {
  let $activeDay;
  let $settings;
  component_subscribe($$self, activeDay, ($$value) => $$invalidate(1, $activeDay = $$value));
  ...
  function goBack() {
    return __awaiter(this, void 0, void 0, function* () {
      const sortedNoteKeys = Object.keys((0, import_obsidian_daily_notes_interface4.getAllDailyNotes)()).sort();
      const currentNoteIndex = sortedNoteKeys.findIndex((key) => key === $activeDay);
      const previousNoteKey = sortedNoteKeys[currentNoteIndex - 1];
      const previousNote = (0, import_obsidian_daily_notes_interface4.getAllDailyNotes)()[previousNoteKey];
      if (!previousNote) {
        new import_obsidian8.Notice("No more daily notes");
        return;
      }
      yield openFileInEditor(previousNote);
      set_store_value(activeDay, $activeDay = previousNoteKey, $activeDay);
    });
  }
  function goForward() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const nextNote = (0, import_obsidian_daily_notes_interface4.getAllDailyNotes)()[nextNoteKey];
      if (!nextNote) {
        new import_obsidian8.Notice("No more daily notes");
        return;
      }
      yield openFileInEditor(nextNote);
      set_store_value(activeDay, $activeDay = nextNoteKey, $activeDay);
    });
  }
  const click_handler = () => {
...
var Controls = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance8, create_fragment11, safe_not_equal, {}, add_css8);
  }
};
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      2)
        ...
        ctx2[1];
      if (dirty & /*$$scope, userHoversOverScroller, $activeDayShown*/
      37) {
...
function instance9($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, activeDayShown, ($$value) => $$invalidate(2, $activeDayShown = $$value));
...
// src/main.ts
var DayPlanner = class extends import_obsidian10.Plugin {
  constructor() {
    super(...arguments);
    this.updateStatusBar = async () => {
      if (dailyNoteExists()) {
        await this.statusBar.update(get_store_value(tasks));
      } else {
