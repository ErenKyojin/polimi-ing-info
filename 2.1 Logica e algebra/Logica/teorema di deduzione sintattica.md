...
> [!theorem] deduzione sintattica
> $\gamma = \Delta \cup \{ \mathcal{B} \}$ un [[insieme]] [[formule ben formate|f.b.f.]] $\Gamma \vdash_{L}  \mathcal{A}$ se e solo se $\Delta \vdash_{L} \mathcal{B} \implies \mathcal{A}$
> 
